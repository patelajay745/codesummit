...
const LandinPageCard: FC<props> = ({ title, description }) => {
  return (
    <>
       ...
       */}
      <Card className="flex-1 2xl:max-w-md min-w-[250px] max-w-sm py-3 gap-2 sm:gap-3 sm:py-4 text-start dark:bg-text-secondary/50 border border-brand/40 rounded-2xl bg-text-secondary/20 shadow-2xl 2xl:hover:scale-110 lg:hover:scale-105 transition delay-150 duration-300 ease-in-out">
